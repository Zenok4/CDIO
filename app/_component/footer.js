const Footer = () => {
  return (
    <div className="flex flex-col w-full h-fit bg-[#374151] text-[#e5e7eb] px-14 py-14 pb-32">
      <div className="flex flex-row">
        <div className="flex flex-col gap-2 justify-center w-[35%]">
          <div className="flex items-center w-full gap-4">
            <img
              ...
              width="80"
            />
            <div className="text-3xl  ">Medical System</div>
          </div>
        ...
        <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
          <div className="grid grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-2">
              <div className="font-bold uppercase text-[#9ca3af] pb-3">Giấy Phép</div>{" "}
              <a href="#xxx" className="hover:underline">
                Con dấu
              </a>{" "}
              <a href="#xxx" className="hover:underline">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[#e5e7eb] mb-2">Theo dõi chúng tôi để nhận được tin tức mới sớm nhất.</p>
      ...
      <div className="text-center">© 2025 Medical System - All rights reserved.</div>
    </div>
  );
};
